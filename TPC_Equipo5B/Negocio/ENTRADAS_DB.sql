...
VALUES
	...
	('Cliente', 'cliente@example.com', 'cliente', 2)



INSERT INTO PreciosEntradas(IdEvento, TipoEntrada, Precio, Cantidad) VALUES
(1, 'Platea', 80000, 50000),
(1, 'Campo', 75000, 40000),
(2, 'Platea', 85000, 15000),
(2, 'Campo', 60000, 10000),
(3, 'Platea', 83000, 20000),
(3, 'Campo', 67000, 25000),
(4, 'Platea', 50000, 34000),
(4, 'Campo', 45000, 40000),
(5, 'Platea', 82000, 10000),
(5, 'Palco', 70000, 12000),
(6, 'Platea', 40000, 13000),
(6, 'Palco', 33000, 29000),
(7, 'Platea', 59000, 12000),
(7, 'Palco', 51000, 23000),
(8, 'Platea', 120000, 14000),
(8, 'Palco', 81000, 17000),
(9, 'General', 8000, 17000),
(9, 'VIP', 16000, 25000),
(10,'General', 13000, 12000),
(10,'VIP', 10000, 9000)